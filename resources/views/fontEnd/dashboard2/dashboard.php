			...
			<div class="category-list">
				<div id="parentVerticalTab">
					<ul class="resp-tabs-list hor_1">
						<a href="{{ url ('/addteam') }}"><li>Teams</li></a>
						<li>Players</li>
						<li>stadium</li>
						<li>Players</li>
						<li>Matches</li>
					...
					<div class="resp-tabs-container hor_1">
						...
						<div>
							...
							<div class="sub-categories">
								<ul>
									<li><a href="{{ url('/addgoal') }}">Add teams</li>
									<li><a href="{{ url('/showteams') }}">Show teams</li>
									<li><a href="{{ url('/showteamsplayers') }}">Team's Players</li>
									<div class="clearfix"></div>
								</ul>
							</div>
						</div>
